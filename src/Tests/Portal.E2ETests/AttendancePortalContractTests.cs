...
public sealed class AttendancePortalContractTests
{
    [Test]
    public void AttendanceNavigation_IsFeatureGatedAndUserDetailLinked()
    {
        var repositoryRoot = FindRepositoryRoot();
        var layoutRoot = Path.Combine(repositoryRoot.FullName, "src", "Presentation", "XFramework.Portal", "Components", "Layout");
        var identityRoot = Path.Combine(repositoryRoot.FullName, "src", "Presentation", "XFramework.Portal", "Components", "Pages", "Identity");
    ...
    [Test]
    public void AttendancePages_UsePortalGridAndPickerConventions()
    {
        var source = ReadAttendancePageSource();
