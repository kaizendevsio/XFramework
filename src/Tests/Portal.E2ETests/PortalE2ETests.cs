...
public class PortalE2ETests : PageTest
{
    ...
    public async Task Dashboard_LoadsWithStatCards()
    {
        ...
        // Page title
        await Expect(Page).ToHaveTitleAsync(new Regex("Dashboard.*Portal"));
    ...
    public async Task Tenants_PageLoads()
    {
        ...
        await Expect(Page).ToHaveTitleAsync(new Regex("Tenant.*Portal"));
    ...
    public async Task Users_PageLoads()
    {
        ...
        await Expect(Page).ToHaveTitleAsync(new Regex("User.*Portal"));
    ...
    public async Task Roles_PageLoads()
    {
        ...
        await Expect(Page).ToHaveTitleAsync(new Regex("Role.*Portal"));
    }
    ...
    public async Task Sessions_PageLoads()
    {
        ...
        await Expect(Page).ToHaveTitleAsync(new Regex("Session.*Portal"));
    }
    ...
    public async Task AuthLogs_PageLoads()
    {
        ...
        await Expect(Page).ToHaveTitleAsync(new Regex("Auth.*Portal"));
    }
    ...
    public async Task Wallets_PageLoads()
    {
        ...
        await Expect(Page).ToHaveTitleAsync(new Regex("Wallet.*Portal"));
    ...
    public async Task Transactions_PageLoads()
    {
        ...
        await Expect(Page).ToHaveTitleAsync(new Regex("Transaction.*Portal"));
    }
    ...
    public async Task BatchOperations_PageLoads()
    {
        ...
        await Expect(Page).ToHaveTitleAsync(new Regex("Batch.*Portal"));
    }
    ...
    public async Task Configurations_PageLoads()
    {
        ...
        await Expect(Page).ToHaveTitleAsync(new Regex("Configuration.*Portal"));
    }
    ...
    public async Task ReferenceData_PageLoads()
    {
        ...
        await Expect(Page).ToHaveTitleAsync(new Regex("Reference.*Portal"));
    ...
    public async Task AllSidebarLinks_Navigate()
    {
        ...
        foreach (var route in routes)
        {
            ...
            title.Should().Contain("Portal", $"Route {route} should have Portal in title");
        }
    }
}
