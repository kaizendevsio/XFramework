namespace ControlPanel.Server.Components.Layout;

public sealed class ControlPanelSidebarState
{
    private readonly HashSet<string> _openGroups = new(StringComparer.OrdinalIgnoreCase);

    public ControlPanelSidebarState(IEnumerable<string> defaultOpenGroups)
    {
