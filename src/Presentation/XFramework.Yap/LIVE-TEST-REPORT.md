...
- Current local suite: **23 passed**, including the actual directory serialization regression and rejected-upstream-logout handling. Live chat remains blocked; these tests are not live API passes.
