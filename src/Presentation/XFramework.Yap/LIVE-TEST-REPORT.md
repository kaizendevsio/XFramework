...
- Current local suite: **25 passed**, including the actual directory serialization regression, rejected-upstream-logout handling, and both direct peer title perspectives. Live chat remains blocked; these tests are not live API passes.
