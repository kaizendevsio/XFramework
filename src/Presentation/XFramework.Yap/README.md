...
On narrow screens or coarse-pointer devices, editable controls use 16px text to avoid input-focus zoom. The viewport remains zoomable. Mobile styles cover login, registration, conversation search, message composers, and dialog controls. Desktop input sizing is retained.
