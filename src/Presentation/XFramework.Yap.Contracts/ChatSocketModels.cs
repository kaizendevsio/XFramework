...
// SessionEnded is the socket's form of the X-Yap-Session: ended header (see SessionSignal).
public sealed record ChatSocketResponse(int Status, JsonElement? Body = null, bool SessionEnded = false);
