...
/// Capacity configurable via StreamFlowConfiguration.DeadLetterQueueCapacity (default 100k).
/// </summary>
public sealed class DeadLetterQueue
{
    ...
    public DeadLetterQueue(StreamFlowConfiguration configuration, ILogger<DeadLetterQueue> logger)
    {
        _logger = logger;
    ...
    public void Enqueue(StreamFlowMessage message, string reason, int retryCount = 0, string? error = null)
    {
