...
namespace Communications.Tests.Domain;

public sealed class MessageModelConfigurationTests
{
    [Test]
    public void CommunicationsModel_MembershipDeliveryAndReactionUniqueness_Configured()
    {
    ...
    [Test]
    public void CommunicationsModel_TimelineAndOutboxIndexes_Configured()
    {
        using var db = CreateDbContext();
