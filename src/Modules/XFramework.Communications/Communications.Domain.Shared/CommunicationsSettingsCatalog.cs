...
public static class CommunicationsSettingsCatalog
{
    ...
    [
        ...
        new(PolicySectionKey, "Communications.Policy", "Attachments.MaxSizeBytes", "Attachment Size Limit", "Maximum linked StorageFile size accepted by Communications.", "4294967296", "bytes", false, CommunicationsGroupSystemReferenceId, CommunicationsSettingValueKind.Number),
        new(PolicySectionKey, "Communications.Policy", "Attachments.AllowedContentFamilies", "Attachment Content Families", "Comma-separated content families accepted for message file links.", "image,video,audio,text,pdf,json,zip,vnd,application", "csv", false, CommunicationsGroupSystemReferenceId, CommunicationsSettingValueKind.Csv),
        ...
        new(PolicySectionKey, "Communications.Policy", "RateLimits.MessageCreatePerMinute", "Message Create Rate", "Maximum new messages per member per minute. The default supports sustained two-message-per-second chat with headroom.", "180", "per-minute", false, CommunicationsGroupSystemReferenceId, CommunicationsSettingValueKind.Number),
        ...
        new(PolicySectionKey, "Communications.Policy", "Moderation.AdminAuditVisible", "Admin Audit Visibility", "Controls whether moderation audit records are visible in Portal.", "true", "boolean", false, CommunicationsGroupSystemReferenceId, CommunicationsSettingValueKind.Boolean),
