...
public static class CreateDepositWorkflowEndpoint
{
    ...
    [MapPost("/api/wallets/deposits", Tags = ["Wallets Deposits"], Summary = "Create deposit request", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Transact])]
...
public static class ValidateDepositWorkflowEndpoint
{
    ...
    [MapPost("/api/wallets/deposits/validate", Tags = ["Wallets Deposits"], Summary = "Validate deposit request", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
    [MapPost("/api/wallets/deposits/approve", Tags = ["Wallets Deposits"], Summary = "Approve deposit request", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
    [MapPost("/api/wallets/deposits/reject", Tags = ["Wallets Deposits"], Summary = "Reject deposit request", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
    [MapPost("/api/wallets/deposits/settle", Tags = ["Wallets Deposits"], Summary = "Settle deposit request", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
    [MapPost("/api/wallets/deposits/fail", Tags = ["Wallets Deposits"], Summary = "Fail deposit request", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Transact])]
    [MapPost("/api/wallets/deposits/cancel", Tags = ["Wallets Deposits"], Summary = "Cancel deposit request", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Transact])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Transact])]
    [MapPost("/api/wallets/withdrawals", Tags = ["Wallets Withdrawals"], Summary = "Create withdrawal request", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Transact])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
    [MapPost("/api/wallets/withdrawals/validate", Tags = ["Wallets Withdrawals"], Summary = "Validate withdrawal request", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
    [MapPost("/api/wallets/withdrawals/approve", Tags = ["Wallets Withdrawals"], Summary = "Approve withdrawal request", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
    [MapPost("/api/wallets/withdrawals/reject", Tags = ["Wallets Withdrawals"], Summary = "Reject withdrawal request", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
    [MapPost("/api/wallets/withdrawals/settle", Tags = ["Wallets Withdrawals"], Summary = "Settle withdrawal request", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
    [MapPost("/api/wallets/withdrawals/fail", Tags = ["Wallets Withdrawals"], Summary = "Fail withdrawal request", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Transact])]
    [MapPost("/api/wallets/withdrawals/cancel", Tags = ["Wallets Withdrawals"], Summary = "Cancel withdrawal request", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Transact])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
    [MapPost("/api/wallets/workflows/expire-due", Tags = ["Wallets Workflows"], Summary = "Expire due wallet workflows", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Admin])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Webhooks])]
    [MapPost("/api/wallets/outbox/retry", Tags = ["Wallets Outbox"], Summary = "Retry outbox message", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Webhooks])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Webhooks])]
    [MapPost("/api/wallets/outbox/replay", Tags = ["Wallets Outbox"], Summary = "Replay outbox message", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Webhooks])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Webhooks])]
    [MapPost("/api/wallets/outbox/dead-letter", Tags = ["Wallets Outbox"], Summary = "Dead-letter outbox message", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Webhooks])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Reconciliation])]
    [MapPost("/api/wallets/reconciliation/run", Tags = ["Wallets Reconciliation"], Summary = "Run wallet reconciliation", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Reconciliation])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Reconciliation])]
    [MapPost("/api/wallets/reconciliation/mark-reconciled", Tags = ["Wallets Reconciliation"], Summary = "Mark reconciliation item reconciled", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Reconciliation])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Policy])]
    [MapPost("/api/wallets/approvals/approve", Tags = ["Wallets Approvals"], Summary = "Approve maker-checker request", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Policy])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Transact])]
    [MapPost("/api/wallets/approvals", Tags = ["Wallets Approvals"], Summary = "Create maker-checker request", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Transact])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Policy])]
    [MapPost("/api/wallets/approvals/reject", Tags = ["Wallets Approvals"], Summary = "Reject maker-checker request", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Policy])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Transact])]
    [MapPost("/api/wallets/cases", Tags = ["Wallets Cases"], Summary = "Create refund, dispute, or chargeback case", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Transact])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Policy])]
    [MapPost("/api/wallets/cases/resolve", Tags = ["Wallets Cases"], Summary = "Resolve refund, dispute, or chargeback case", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Policy])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Policy])]
    [MapPost("/api/wallets/policy/rules/upsert", Tags = ["Wallets Policy"], Summary = "Create or update wallet policy rule", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Policy])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Policy])]
    [MapPost("/api/wallets/policy/fee-schedules/upsert", Tags = ["Wallets Policy"], Summary = "Create or update wallet fee schedule", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Policy])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Reporting])]
    [MapPost("/api/wallets/reports/statement", Tags = ["Wallets Reporting"], Summary = "Get wallet statement", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Reporting])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Reporting])]
    [MapPost("/api/wallets/reports/ledger-entries", Tags = ["Wallets Reporting"], Summary = "Get wallet ledger entries", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Reporting])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Reporting])]
    [MapPost("/api/wallets/reports/balance-as-of", Tags = ["Wallets Reporting"], Summary = "Get wallet balance as of a date", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Reporting])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Reporting])]
    [MapPost("/api/wallets/reports/operation-history", Tags = ["Wallets Reporting"], Summary = "Get wallet operation history", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Reporting])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Reporting])]
    [MapPost("/api/wallets/reports/failed-rejected-operations", Tags = ["Wallets Reporting"], Summary = "Get failed and rejected wallet operations", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Reporting])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Reporting])]
    [MapPost("/api/wallets/reports/unreconciled-balances", Tags = ["Wallets Reporting"], Summary = "Get unreconciled wallet balances", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Reporting])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Reporting])]
    [MapPost("/api/wallets/reports/outbox-failures", Tags = ["Wallets Reporting"], Summary = "Get wallet outbox failures", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Reporting])]
...
{
    [BoltHandler(RequiredActorCapabilities = [WalletAuthorizationCapabilities.Reporting])]
    [MapPost("/api/wallets/reports/settlements", Tags = ["Wallets Reporting"], Summary = "Get deposit and withdrawal settlement report", RequireAuthorization = true, RequiredActorCapabilities = [WalletAuthorizationCapabilities.Reporting])]
