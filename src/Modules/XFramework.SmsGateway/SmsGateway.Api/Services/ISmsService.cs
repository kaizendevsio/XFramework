...
public interface ISmsService
{
    ...
    /// <summary>
    /// Gets pending SMS messages and updates their status to Processing
    /// </summary>
    /// <param name="agentClusterId">The agent cluster ID</param>
    /// <param name="ct">Cancellation token</param>
    /// <returns>Result containing the list of messages set to processing</returns>
    Task<Result<List<SmsNodeJob>>> GetPendingWithStatusUpdateAsync(Guid agentClusterId, CancellationToken ct = default);
}