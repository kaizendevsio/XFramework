...
public class CommunityConnectionTypeConfiguration : IEntityTypeConfiguration<CommunityConnectionType>
{
    public void Configure(EntityTypeBuilder<CommunityConnectionType> entity)
    {
