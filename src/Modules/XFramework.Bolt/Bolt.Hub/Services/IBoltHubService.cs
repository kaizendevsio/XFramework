...
/// <summary>
/// Service interface for Bolt SignalR messaging operations.
...
/// </summary>
public interface IBoltHubService
{
    /// <summary>
    /// Pushes a message to Bolt clients based on exchange type (FanOut, Direct, Topic).
    ...
    /// <summary>
    /// Registers a Bolt client for message delivery.
    ...
    Task<Result<BoltInvokeResponse>> InvokeMethodAsync(
        BoltMessage message,
        HubCallerContext context,
        CancellationToken cancellationToken = default);
