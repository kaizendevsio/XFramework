...
public sealed class MessagingAdminReadService(IDataContext dataContext) : IMessagingAdminReadService
{
        ...
        CancellationToken ct = default)
    {
        ...
        return Result<MessagingAdminUsersResponse>.Success(new MessagingAdminUsersResponse
        {
            Summary = new MessagingAdminUsersSummary
            {
                MessagingUserCount = rows.Count,
    ...
    public async Task<Result<MessagingAdminUserDetailResponse>> GetUserDetailAsync(
        ...
        CancellationToken ct = default)
    {
        ...
        {
            return Result<MessagingAdminUserDetailResponse>.NotFound("Messaging user was not found for this tenant.");
        }
        ...
        return Result<MessagingAdminUserDetailResponse>.Success(new MessagingAdminUserDetailResponse
        {
            Credential = ToCredentialContext(credential),
            Summary = new MessagingAdminUserDetailSummary
            {
    ...
    public async Task<Result<MessagingAdminThreadsResponse>> QueryThreadsAsync(
        ...
        CancellationToken ct = default)
    {
        ...
        return Result<MessagingAdminThreadsResponse>.Success(new MessagingAdminThreadsResponse
        {
            Summary = new MessagingAdminThreadsSummary
            {
    ...
    public async Task<Result<MessagingAdminThreadDetailResponse>> GetThreadDetailAsync(
        ...
        CancellationToken ct = default)
    {
        ...
        if (thread is null)
        {
            return Result<MessagingAdminThreadDetailResponse>.NotFound("Messaging thread was not found for this tenant.");
        }
        ...
        return Result<MessagingAdminThreadDetailResponse>.Success(new MessagingAdminThreadDetailResponse
        {
            Thread = new MessagingAdminThreadContext
            {
                Id = thread.Id,
            ...
            Summary = new MessagingAdminThreadDetailSummary
            {
    ...
    public async Task<Result<MessagingAdminOperationsResponse>> GetOperationsAsync(
    ...
    public async Task<Result<MessagingAdminModerationResponse>> GetModerationAsync(
    ...
    private async Task<List<MessagingAdminUserRow>> BuildUserRowsAsync(
        Guid tenantId,
    ...
    private async Task<List<MessagingAdminThreadRow>> BuildThreadRowsAsync(
        Guid tenantId,
        CancellationToken ct)
    {
        var threads = await dataContext.Query<MessageThread>()
        ...
        return threads
            .Select(thread =>
            {
                ...
                return new MessagingAdminThreadRow
                {
                    Id = thread.Id,
                    Name = DisplayThreadName(thread),
    ...
    private async Task<MessagingAdminOperationContext> LoadOperationsContextAsync(
        Guid tenantId,
        CancellationToken ct)
    {
        var threads = await dataContext.Query<MessageThread>()
        ...
        return new MessagingAdminOperationContext(
    ...
    private static MessagingAdminUserRow CreateUserRow(
        Guid credentialId,
        ...
        IReadOnlyCollection<MessageBlock> blocks)
    {
        ...
        return new MessagingAdminUserRow
        {
    ...
    private static MessagingAdminCredentialContext ToCredentialContext(IdentityCredential credential) =>
        new()
        {
            Id = credential.Id,
            IdentityInfoId = credential.IdentityInfoId,
    ...
    private static MessagingAdminUserThreadRow ToUserThreadRow(
    ...
    private static MessagingAdminUserMessageRow ToUserMessageRow(
        Message message,
        MessageThread? thread) =>
        new()
        {
    ...
    private static MessagingAdminUserInviteRow ToUserInviteRow(
    ...
    private static MessagingAdminUserBlockRow ToUserBlockRow(
        MessageBlock block,
        Guid credentialId,
        IReadOnlyDictionary<Guid, IdentityCredential> credentials)
    {
        ...
        return new MessagingAdminUserBlockRow
        {
            BlockId = block.Id,
    ...
    private static MessagingAdminThreadMemberRow ToThreadMemberRow(MessageThreadMember member) =>
        new()
        {
            MemberId = member.Id,
    ...
    private static MessagingAdminThreadMessageRow ToThreadMessageRow(
        Message message,
        MessageThreadMember? member) =>
        new()
        {
    ...
    private static MessagingAdminOutboxRow ToOutboxRow(
        MessageOutboxEvent item,
        MessagingAdminOperationContext context) =>
        new()
        {
            Id = item.Id,
    ...
    private static MessagingAdminOperationInviteRow ToOperationInviteRow(
        ...
        MessagingAdminOperationContext context)
    {
        ...
        return new MessagingAdminPinRow
        {
            Id = item.Id,
            ThreadId = item.MessageThreadId,
            Thread = GetThreadLabel(item.MessageThreadId, context.Threads),
    ...
    private static MessagingAdminSavedRow ToSavedRow(
        MessageSaved item,
        MessagingAdminOperationContext context)
    {
        var message = context.Messages.GetValueOrDefault(item.MessageId);

        return new MessagingAdminSavedRow
        {
            Id = item.Id,
            ThreadId = message?.MessageThreadId,
    ...
    private static MessagingAdminReportRow ToReportRow(
        MessageReport item,
        MessagingAdminOperationContext context)
    {
        var message = context.Messages.GetValueOrDefault(item.MessageId);
        ...
        return new MessagingAdminReportRow
        {
            Id = item.Id,
    ...
    private static MessagingAdminBlockRow ToModerationBlockRow(
        MessageBlock item,
        MessagingAdminOperationContext context) =>
        new()
        {
    ...
    private static GridPage<T> ApplyGrid<T>(
        ...
        MessagingAdminGridRequest request)
    {
    ...
    private static IEnumerable<T> ApplyFilters<T>(
        IEnumerable<T> source,
        IReadOnlyCollection<MessagingAdminFilter>? filters)
    {
    ...
    private static IEnumerable<T> ApplySort<T>(
        IEnumerable<T> source,
        IReadOnlyCollection<MessagingAdminSort>? sorts)
    {
    ...
    private static bool MatchesFilter(object? value, MessagingAdminFilter filter)
    {
    ...
    private sealed record MessagingAdminOperationContext(
        IReadOnlyDictionary<Guid, MessageThread> Threads,
        IReadOnlyDictionary<Guid, MessageThreadMember> Members,
