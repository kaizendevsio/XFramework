...
namespace Messaging.Api.Features.Platform;

public static class CreateDirectThreadEndpoint
{
    [BoltHandler]
    [MapPost("/api/threads/direct", Tags = ["Threads"],
...
{
    [BoltHandler]
    [MapGet("/api/threads/unread-counts", Tags = ["Threads"],
...
{
    [BoltHandler]
    [MapPost("/api/threads/{threadId:guid}/leave", Tags = ["Threads"],
...
{
    [BoltHandler]
    [MapPatch("/api/threads/{threadId:guid}/mute", Tags = ["Threads"],
...
{
    [BoltHandler]
    [MapPatch("/api/threads/{threadId:guid}/archive", Tags = ["Threads"],
...
{
    [BoltHandler]
    [MapPost("/api/threads/{threadId:guid}/invites", Tags = ["Thread Invites"],
...
{
    [BoltHandler]
    [MapPost("/api/threads/{threadId:guid}/invites/{inviteId:guid}/accept", Tags = ["Thread Invites"],
...
{
    [BoltHandler]
    [MapPost("/api/threads/{threadId:guid}/invites/{inviteId:guid}/decline", Tags = ["Thread Invites"],
...
{
    [BoltHandler]
    [MapPatch("/api/threads/{threadId:guid}/members/{memberId:guid}/role", Tags = ["Thread Members"],
...
{
    [BoltHandler]
    [MapPost("/api/threads/{threadId:guid}/messages/{messageId:guid}/pin", Tags = ["Messages"],
...
{
    [BoltHandler]
    [MapDelete("/api/threads/{threadId:guid}/messages/{messageId:guid}/pin", Tags = ["Messages"],
...
{
    [BoltHandler]
    [MapPost("/api/threads/{threadId:guid}/messages/{messageId:guid}/save", Tags = ["Messages"],
...
{
    [BoltHandler]
    [MapDelete("/api/threads/{threadId:guid}/messages/{messageId:guid}/save", Tags = ["Messages"],
...
{
    [BoltHandler]
    [MapGet("/api/messages/search", Tags = ["Messages"],
...
{
    [BoltHandler]
    [MapPost("/api/threads/{threadId:guid}/messages/{messageId:guid}/report", Tags = ["Moderation"],
...
{
    [BoltHandler]
    [MapPost("/api/messaging/blocks", Tags = ["Moderation"],
        Summary = "Block a credential",
        Description = "Blocks another credential from 1:1 direct messaging with the requester.")]
    public static Task<Result<CmdResponse>> Handle(
...
{
    [BoltHandler]
    [MapDelete("/api/messaging/blocks/{credentialId:guid}", Tags = ["Moderation"],
        Summary = "Remove a credential block",
        Description = "Removes a 1:1 direct messaging block created by the requester.")]
    public static Task<Result<CmdResponse>> Handle(
