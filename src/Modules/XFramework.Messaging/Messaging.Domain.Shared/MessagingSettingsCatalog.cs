...
public static class MessagingSettingsCatalog
{
    ...
    [
        ...
        new(PolicySectionKey, "Messaging.Policy", "RateLimits.AttachmentLinkPerMinute", "Attachment Link Rate", "Tenant policy target for message attachment link actions.", "30", "per-minute", false, MessagingGroupSystemReferenceId, MessagingSettingValueKind.Number),
        new(PolicySectionKey, "Messaging.Policy", "RateLimits.ReportCreatePerMinute", "Report Create Rate", "Tenant policy target for moderation report creation.", "10", "per-minute", false, MessagingGroupSystemReferenceId, MessagingSettingValueKind.Number),
        new(PolicySectionKey, "Messaging.Policy", "RateLimits.DirectExternalTransportPerMinute", "External Direct Transport Rate", "Tenant policy target for direct external transport requests.", "20", "per-minute", false, MessagingGroupSystemReferenceId, MessagingSettingValueKind.Number),
