...
public sealed class MessagingServiceDirectTransportTests
{
    private const string TrustedMetadataSecret = "messaging-direct-transport-test-secret";
    ...
    public async Task CreateDirectMessageAsync_UnsupportedTransport_DoesNotPersistDirectMessage()
    {
        ...
        var service = new MessagingService(
            ...
            new TestMessagingTemplateService(),
    ...
    private sealed class TestMessagingTemplateService : IMessagingTemplateService
    {
