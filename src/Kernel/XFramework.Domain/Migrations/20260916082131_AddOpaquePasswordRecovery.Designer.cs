...
namespace XFramework.Domain.Migrations
{
    ...
    [Migration("20260916082131_AddOpaquePasswordRecovery")]
    partial class AddOpaquePasswordRecovery
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Communications.Domain.Shared.Contracts.Message", b =>
                {
                    ...
                    b.Property<string>("EncryptionAudienceJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValueSql("'[]'::jsonb");

                    b.Property<string>("EncryptionOriginalEnvelopeHash")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.Property<int>("PendingEncryptionCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);

                    b.Property<string>("PendingEncryptionMembersJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValueSql("'[]'::jsonb");
                    ...
                    b.HasIndex("TenantId", "MessageThreadMemberId", "CreatedAt", "Id")
            ...
            modelBuilder.Entity("Communications.Domain.Shared.Contracts.MessageThreadMember", b =>
                {
                    ...
                    b.Property<bool>("HideActiveStatus")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("IdentityServer.Domain.Shared.Contracts.EncryptionAccount", b =>
                {
                    ...
                    b.Property<string>("PublicHistoryJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValue("[]");
            ...
            modelBuilder.Entity("IdentityServer.Domain.Shared.Contracts.OpaqueCredential", b =>
                {
                    b.Property<Guid>("TenantId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("WrappedRecovery")
                        .IsRequired()
                        .HasMaxLength(4096)
                    ...
                    b.ToTable("OpaqueCredential", "Identity");
                });
            ...
            modelBuilder.Entity("Notifications.Domain.Shared.Contracts.NotificationPushSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("POS.Domain.Shared.Contracts.PosPayment", b =>
                {
                    ...
                    b.Property<decimal?>("CashTenderedAmount")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
            ...
            modelBuilder.Entity("XFramework.Domain.Auditing.AuditEvent", b =>
                {
                    ...
                    b.Property<Guid?>("ActorCredentialId")
                        .HasColumnType("uuid")
                        .HasColumnName("actor_credential_id");
                    ...
                    b.Property<Guid?>("EffectiveTenantId")
                        .HasColumnType("uuid")
                        .HasColumnName("effective_tenant_id");
                    ...
                    b.Property<Guid?>("SubjectTenantIdAfter")
                        .HasColumnType("uuid")
                        .HasColumnName("subject_tenant_id_after");

                    b.Property<Guid?>("SubjectTenantIdBefore")
                        .HasColumnType("uuid")
                        .HasColumnName("subject_tenant_id_before");
                    ...
                    b.Property<int>("TransactionOrdinal")
                        .HasColumnType("integer")
                        .HasColumnName("transaction_ordinal");
                    ...
                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("RecordedAt"), "brin");

                    b.HasIndex("ActorCredentialId", "EventId");

                    b.HasIndex("SubjectTenantIdAfter", "EventId");

                    b.HasIndex("SubjectTenantIdBefore", "EventId");

                    b.HasIndex("SchemaName", "TableName", "EventId");

                    b.ToTable("event", "audit", t =>
                        {
                            t.HasComment("Append-only, database-triggered audit trail.");
                        });
                });
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.StorageTenantBucket", b =>
                {
                    ...
                    b.HasIndex("TenantId", "ProviderProfileId", "Purpose")
                        .IsUnique()
            ...
            modelBuilder.Entity("XFramework.Inventario.Domain.Shared.Contracts.InventoryReorderRule", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("TenantId", "ProductId", "ProductVariationId", "WarehouseId", "LocationId"), false);
