...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.Biller", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.BillerCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.BillerField", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.BillsPaymentTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.BinaryList", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.BinaryListMultiplex", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.BinaryMap", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.EloadGatewayNumber", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.EloadProductCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.EloadPromo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.EloadTelcoPrefix", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.EloadTelcoType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.EloadTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.IncomeDistribution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.IncomePartition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.Log", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.ProviderEndpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.ProviderType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.SessionDatum", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.Biller", b =>
                {
                    b.HasOne("XFramework.Domain.Shared.Contracts.BillerCategory", "BillerCategory")
                        .WithMany("Billers")
                        .HasForeignKey("BillerCategoryId")
                        .IsRequired()
                        .HasConstraintName("tbl_billers_tbl_billercategories_id_fk");

                    b.HasOne("XFramework.Domain.Shared.Contracts.ProviderEndpoint", "ProviderEndpoint")
                        .WithMany("Billers")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.BillerCategory", b =>
                {
                    b.HasOne("XFramework.Domain.Shared.Contracts.ProviderType", "ProviderType")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.BillerField", b =>
                {
                    b.HasOne("XFramework.Domain.Shared.Contracts.Biller", "Biller")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.BillsPaymentTransaction", b =>
                {
                    ...
                    b.HasOne("XFramework.Domain.Shared.Contracts.IncomeTransaction", "IncomeTransaction")
                        .WithMany("BillsPaymentTransactions")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.BinaryList", b =>
                {
                    b.HasOne("XFramework.Domain.Shared.Contracts.BinaryMap", "SourceUserMap")
                        .WithMany("BinaryListSourceUserMaps")
                        .HasForeignKey("SourceUserMapId")
                        .HasConstraintName("tbl_userbinarylist_tbl_usermap_id_fk_2");

                    b.HasOne("XFramework.Domain.Shared.Contracts.BinaryMap", "TargetUserMap")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.BinaryListMultiplex", b =>
                {
                    b.HasOne("XFramework.Domain.Shared.Contracts.BinaryMap", "BinaryMap")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.BinaryMap", b =>
                {
                    b.HasOne("XFramework.Domain.Shared.Contracts.BusinessPackage", "IdNavigation")
                        .WithOne("BinaryMap")
                        .HasForeignKey("XFramework.Domain.Shared.Contracts.BinaryMap", "Id")
                        .IsRequired()
                        .HasConstraintName("tbl_usermap_fk");

                    b.HasOne("XFramework.Domain.Shared.Contracts.BinaryMap", "SponsorUser")
                        .WithMany("InverseSponsorUser")
                        .HasForeignKey("SponsorUserId")
                        .HasConstraintName("SponsorUserId");

                    b.HasOne("XFramework.Domain.Shared.Contracts.BinaryMap", "UplineUser")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.EloadGatewayNumber", b =>
                {
                    b.HasOne("XFramework.Domain.Shared.Contracts.EloadTelcoType", "EloadTelcoType")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.EloadProductCode", b =>
                {
                    b.HasOne("XFramework.Domain.Shared.Contracts.EloadPromo", "EloadPromo")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.EloadTelcoPrefix", b =>
                {
                    b.HasOne("XFramework.Domain.Shared.Contracts.EloadTelcoType", "TelcoType")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.EloadTransaction", b =>
                {
                    ...
                    b.HasOne("XFramework.Domain.Shared.Contracts.EloadProductCode", "EloadProductCode")
                        .WithMany("EloadTransactions")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.IncomePartition", b =>
                {
                    b.HasOne("XFramework.Domain.Shared.Contracts.IdentityRole", "IdentityRole")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.IncomeTransaction", b =>
                {
                    ...
                    b.HasOne("XFramework.Domain.Shared.Contracts.BinaryMap", "PairMap")
                    ...
                    b.HasOne("XFramework.Domain.Shared.Contracts.BinaryMap", "SourceMap")
                    ...
                    b.HasOne("XFramework.Domain.Shared.Contracts.BinaryMap", "TargetMap")
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.Log", b =>
                {
                    b.HasOne("XFramework.Domain.Shared.Contracts.Tenant", "Application")
                        .WithMany("Logs")
                        .HasForeignKey("TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
            ...
            modelBuilder.Entity("XFramework.Domain.Shared.Contracts.ProviderEndpoint", b =>
                {
                    b.HasOne("XFramework.Domain.Shared.Contracts.ProviderType", "Provider")
