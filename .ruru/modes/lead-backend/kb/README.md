+++
id = "KB-LOOKUP-RULE-LEAD-BACKEND"
title = "Standard: lead-backend KB Lookup & Index"
context_type = "rules"
...
# related_context = []
tags = ["kb-lookup", "knowledge-base", "rule", "template", "conditional", "research", "mcp", "lead-backend"]
# relevance = ""
kb_directory = ".ruru/modes/lead-backend/kb/"
+++

# Knowledge Base (KB) Lookup Rule (Conditional + Info Gathering)

**Applies To:** `lead-backend` mode
...
2.  **Conditional KB Consultation:**
    *   **IF** the task is assessed as **complex, novel, high-risk, or uncertain**:
        *   **MUST** consult the dedicated Knowledge Base (KB) directory for this mode located at: `.ruru/modes/lead-backend/kb/`
...
2.  **Scan KB:**
    *   a. **Read `README.md`:** Always start by reading the `.ruru/modes/lead-backend/kb/README.md` for an overview and structure guidance.
    *   b. **List Contents:** Identify relevant files and subdirectories within `.ruru/modes/lead-backend/kb/`.
...
*This section provides an overview and index of the knowledge base documents available for the `lead-backend` mode. Use this index to quickly locate relevant information for the task at hand.*
