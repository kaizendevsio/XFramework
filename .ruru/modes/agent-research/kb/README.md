+++
id = "KB-LOOKUP-RULE-AGENT-RESEARCH-V3" # Updated ID
title = "Standard: agent-research KB Lookup & Index" # Updated title
context_type = "rules"
...
# related_context = []
tags = ["kb-lookup", "knowledge-base", "rule", "template", "conditional", "research", "mcp", "agent-research"] # Added tags
# relevance = ""
...
**Applies To:** `agent-research` mode
...
2.  **Conditional KB Consultation:**
    *   **IF** the task is assessed as **complex, novel, high-risk, or uncertain**:
        *   **MUST** consult the dedicated Knowledge Base (KB) directory for this mode located at: `.ruru/modes/agent-research/kb/`
...
2.  **Scan KB:**
    *   a. **Read `README.md`:** Always start by reading the `.ruru/modes/agent-research/kb/README.md` for an overview and structure guidance.
    *   b. **List Contents:** Identify relevant files and subdirectories within `.ruru/modes/agent-research/kb/`.
...
*This section provides an overview and index of the knowledge base documents available for the `agent-research` mode. Use this index to quickly locate relevant information for the task at hand.*
