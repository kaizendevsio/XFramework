+++
id = "KB-LOOKUP-RULE-DEV-REACT"
title = "Standard: dev-react KB Lookup & Index"
context_type = "rules"
...
# related_context = []
tags = ["kb-lookup", "knowledge-base", "rule", "template", "conditional", "research", "mcp", "dev-react"]
# relevance = ""
...
2.  **Conditional KB Consultation:**
    *   **IF** the task is assessed as **complex, novel, high-risk, or uncertain**:
        *   **MUST** consult the dedicated Knowledge Base (KB) directory for this mode located at: `.ruru/modes/dev-react/kb/`
...
2.  **Scan KB:**
    *   a. **Read `README.md`:** Always start by reading the `.ruru/modes/dev-react/kb/README.md` for an overview and structure guidance.
    *   b. **List Contents:** Identify relevant files and subdirectories within `.ruru/modes/dev-react/kb/`.
...
*This section provides an overview and index of the knowledge base documents available for the `dev-react` mode. Use this index to quickly locate relevant information for the task at hand.*
