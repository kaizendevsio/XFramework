...
Start-Process powershell { dotnet run --project 'C:\Projects\Net Core\XFramework\XFramework\XFramework.Subsystems\XFramework.IdentityServer\IdentityServer.Api\IdentityServer.Api.csproj' } -WindowStyle Minimized
Start-Process powershell { dotnet run --project 'C:\Projects\Net Core\XFramework\XFramework\XFramework.Subsystems\XFramework.Wallets\Wallets.Api\Wallets.Api.csproj' } -WindowStyle Minimized
...
Start-Process powershell { dotnet run --project 'C:\Projects\Net Core\XFramework\XFramework\XFramework.Subsystems\XFramework.Community.sln' } -WindowStyle Minimized
