...
pack "src/Modules/XFramework.Messaging/Messaging.Domain.Shared/Messaging.Domain.Shared.csproj"
pack "src/Modules/XFramework.Messaging/Messaging.Integration/Messaging.Integration.csproj"
