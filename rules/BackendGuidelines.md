...
- Intentional legacy schema exceptions must be documented. IdentityServer's current exceptions are recorded in `docs/solutions/architecture-patterns/identityserver-schema-ownership-exceptions.md`.
