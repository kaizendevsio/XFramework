...
public partial class SessionState
{
    ...
    public class SetNavigationHistoryHandler : ActionHandler<NavigateToPathAction>
    {
        ...
        public override async Task<Unit> Handle(NavigateToPathAction action, CancellationToken cancellationToken)
        {
