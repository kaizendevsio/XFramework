...
public partial class SessionState
{
    public class ForgotPasswordHandler : ActionHandler<ForgotPassword>
    {
        ...
        public override async Task<Unit> Handle(ForgotPassword action, CancellationToken aCancellationToken)
        {
