...
{
    public class GetNotificationListHandler : ActionHandler<GetNotificationList>
    {
        public GetNotificationListHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(GetNotificationList action, CancellationToken aCancellationToken)
        {
