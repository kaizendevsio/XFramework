...
{
    public class CreateNotificationHandler : ActionHandler<CreateNotification>
    {
        public CreateNotificationHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
