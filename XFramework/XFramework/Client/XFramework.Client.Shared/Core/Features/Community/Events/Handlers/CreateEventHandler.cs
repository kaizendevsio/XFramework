...
{
    public class CreateEventHandler : ActionHandler<CreateEvent>
    {
        public CreateEventHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(CreateEvent action, CancellationToken aCancellationToken)
        {
