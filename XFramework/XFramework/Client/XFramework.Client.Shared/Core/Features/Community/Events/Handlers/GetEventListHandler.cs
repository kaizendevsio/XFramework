...
{
    public class GetEventListHandler : ActionHandler<GetEventList>
    {
        public GetEventListHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
