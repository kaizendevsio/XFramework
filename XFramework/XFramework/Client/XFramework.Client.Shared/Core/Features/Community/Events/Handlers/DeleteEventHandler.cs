...
{
    public class DeleteEventHandler : ActionHandler<DeleteEvent>
    {
        public DeleteEventHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(DeleteEvent action, CancellationToken aCancellationToken)
        {
