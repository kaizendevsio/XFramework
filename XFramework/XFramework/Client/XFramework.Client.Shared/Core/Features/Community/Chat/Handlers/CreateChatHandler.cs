...
{
    public class CreateChatHandler : ActionHandler<CreateChat>
    {
        public CreateChatHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(CreateChat action, CancellationToken aCancellationToken)
        {
