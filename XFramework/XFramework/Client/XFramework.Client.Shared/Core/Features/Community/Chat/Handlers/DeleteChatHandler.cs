...
{
    public class DeleteChatHandler : ActionHandler<DeleteChat>
    {
        public DeleteChatHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(DeleteChat action, CancellationToken aCancellationToken)
        {
