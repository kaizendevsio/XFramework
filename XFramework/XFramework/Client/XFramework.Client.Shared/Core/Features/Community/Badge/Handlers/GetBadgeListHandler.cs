...
{
    public class GetBadgeListHandler : ActionHandler<GetBadgeList>
    {
        public GetBadgeListHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
