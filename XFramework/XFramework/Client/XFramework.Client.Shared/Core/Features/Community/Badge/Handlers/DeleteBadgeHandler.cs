...
{
    public class DeleteBadgeHandler : ActionHandler<DeleteBadge>
    {
        public DeleteBadgeHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(DeleteBadge action, CancellationToken aCancellationToken)
        {
