...
{
    public class CreateBadgeHandler : ActionHandler<CreateBadge>
    {
        public CreateBadgeHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(CreateBadge action, CancellationToken aCancellationToken)
        {
