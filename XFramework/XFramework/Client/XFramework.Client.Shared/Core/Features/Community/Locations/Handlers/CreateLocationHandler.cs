...
{
    public class CreateLocationHandler : ActionHandler<CreateLocation>
    {
        public CreateLocationHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(CreateLocation action, CancellationToken aCancellationToken)
        {
