...
{
    public class DeleteLocationHandler : ActionHandler<DeleteLocation>

    {
        public DeleteLocationHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
