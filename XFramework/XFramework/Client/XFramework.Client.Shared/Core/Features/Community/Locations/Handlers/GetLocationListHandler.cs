...
{
    public class GetLocationListHandler : ActionHandler<GetLocationList>
    {
        public GetLocationListHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(GetLocationList action, CancellationToken aCancellationToken)
        {
