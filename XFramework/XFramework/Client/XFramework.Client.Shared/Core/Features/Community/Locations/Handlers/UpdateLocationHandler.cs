...
{
    public class UpdateLocationHandler : ActionHandler<UpdateLocation>
    {
        public UpdateLocationHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(UpdateLocation action, CancellationToken aCancellationToken)
        {
