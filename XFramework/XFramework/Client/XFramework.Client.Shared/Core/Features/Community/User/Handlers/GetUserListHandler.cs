...
{
    public class GetUserListHandler : ActionHandler<GetUserList>
    {
        public GetUserListHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(GetUserList action, CancellationToken aCancellationToken)
        {
