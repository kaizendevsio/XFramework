...
{
    public class DeleteUserHandler : ActionHandler<DeleteUser>
    {
        public DeleteUserHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(DeleteUser action, CancellationToken aCancellationToken)
        {
