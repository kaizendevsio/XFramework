...
{
    public class AcceptUserHandler : ActionHandler<AcceptUser>
    {
        public AcceptUserHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(AcceptUser action, CancellationToken aCancellationToken)
        {
