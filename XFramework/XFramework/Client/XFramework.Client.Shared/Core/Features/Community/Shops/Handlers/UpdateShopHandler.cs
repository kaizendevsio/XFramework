...
{
    public class UpdateShopHandler : ActionHandler<UpdateShop>
    {
        public UpdateShopHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
