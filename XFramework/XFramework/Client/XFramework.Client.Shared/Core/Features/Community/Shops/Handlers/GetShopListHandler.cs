...
{
    public class GetShopListHandler : ActionHandler<GetShopList>
    {
        public GetShopListHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(GetShopList action, CancellationToken aCancellationToken)
        {
