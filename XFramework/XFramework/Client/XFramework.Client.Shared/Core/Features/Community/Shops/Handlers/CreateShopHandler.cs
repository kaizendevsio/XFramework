...
{
    public class CreateShopHandler : ActionHandler<CreateShop>
    {
        public CreateShopHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(CreateShop action, CancellationToken aCancellationToken)
        {
