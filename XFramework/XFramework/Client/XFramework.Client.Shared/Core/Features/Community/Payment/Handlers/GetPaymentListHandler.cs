...
{
    public class GetPaymentListHandler : ActionHandler<GetPaymentList>
    {
        public GetPaymentListHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(GetPaymentList action, CancellationToken aCancellationToken)
        {
