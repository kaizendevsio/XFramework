...
{
    public class UpdatePaymentHandler : ActionHandler<UpdatePayment>
    {
        public UpdatePaymentHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
