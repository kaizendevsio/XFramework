...
{
    public class UnFollowFriendHandler: ActionHandler<UnFollowFriend>
    {
        ...
        public UnFollowFriendHandler(ICommunityServiceWrapper communityServiceWrapper, IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(UnFollowFriend action, CancellationToken aCancellationToken)
        {
