...
{
    public class DeleteFriendRequestHandler: ActionHandler<DeleteFriendRequest>
    {
        ...
        public DeleteFriendRequestHandler(ICommunityServiceWrapper communityServiceWrapper, IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(DeleteFriendRequest action, CancellationToken aCancellationToken)
        {
