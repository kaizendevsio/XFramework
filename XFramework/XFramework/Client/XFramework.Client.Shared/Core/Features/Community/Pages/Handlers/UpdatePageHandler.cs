...
{
    public class UpdatePageHandler : ActionHandler<UpdatePage>
    {
        public UpdatePageHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(UpdatePage action, CancellationToken aCancellationToken)
        {
