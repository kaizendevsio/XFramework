...
{
    public class GetPageListHandler : ActionHandler<GetPageList>
    {
        public GetPageListHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(GetPageList action, CancellationToken aCancellationToken)
        {
