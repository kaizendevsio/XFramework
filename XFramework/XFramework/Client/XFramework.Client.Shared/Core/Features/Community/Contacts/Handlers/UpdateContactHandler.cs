...
{
    public class UpdateContactHandler : ActionHandler<UpdateContact>
    {
        public UpdateContactHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(UpdateContact action, CancellationToken aCancellationToken)
        {
