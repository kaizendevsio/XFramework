...
{
    public class CreateContactHandler : ActionHandler<CreateContact>
    {
        public CreateContactHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(CreateContact action, CancellationToken aCancellationToken)
        {
