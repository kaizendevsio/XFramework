...
{
    public class DeleteContactHandler : ActionHandler<DeleteContact>
    {
        public DeleteContactHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(DeleteContact action, CancellationToken aCancellationToken)
        {
