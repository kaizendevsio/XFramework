namespace XFramework.Client.Shared.Core.Features.Media;

public partial class MediaState
{
    public class DeleteMediaHandler : ActionHandler<DeleteMedia>
    {
        public DeleteMediaHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(DeleteMedia action, CancellationToken aCancellationToken)
        {
