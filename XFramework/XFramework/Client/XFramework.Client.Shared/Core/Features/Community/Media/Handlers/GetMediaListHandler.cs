...
{
    public class GetMediaListHandler : ActionHandler<GetMediaList>
    {
        public GetMediaListHandler(IConfiguration configuration
        ...
        public override async Task<Unit> Handle(GetMediaList action, CancellationToken aCancellationToken)
        {
