...
{
    public class CreateMediaHandler : ActionHandler<CreateMedia>
    {
        public CreateMediaHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
