...
{
    public class CreateStoryHandler : ActionHandler<CreateStory>
    {
        public CreateStoryHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
