...
{
    public class GetStoryListHandler : ActionHandler<GetStoryList>
    {
        public GetStoryListHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(GetStoryList action, CancellationToken aCancellationToken)
        {
