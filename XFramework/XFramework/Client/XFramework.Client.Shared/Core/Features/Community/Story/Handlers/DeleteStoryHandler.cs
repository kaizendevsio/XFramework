...
{
    public class DeleteStoryHandler : ActionHandler<DeleteStory>
    {
        public DeleteStoryHandler(IConfiguration configuration, ISessionStorageService sessionStorageService,
        ...
        public override async Task<Unit> Handle(DeleteStory action, CancellationToken aCancellationToken)
        {
