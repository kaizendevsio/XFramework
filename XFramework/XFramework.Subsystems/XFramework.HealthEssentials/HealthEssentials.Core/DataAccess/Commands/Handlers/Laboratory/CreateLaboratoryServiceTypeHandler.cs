...
public class CreateLaboratoryServiceTypeHandler : CommandBaseHandler, IRequestHandler<CreateLaboratoryServiceTypeCmd, CmdResponse<CreateLaboratoryServiceTypeCmd>>
{
    public CreateLaboratoryServiceTypeHandler(IDataLayer dataLayer)
    {
        _dataLayer = dataLayer;
    }
    
    public async Task<CmdResponse<CreateLaboratoryServiceTypeCmd>> Handle(CreateLaboratoryServiceTypeCmd request, CancellationToken cancellationToken)
    {
