    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ID = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "(uuid_generate_v4())"),
                    CredentialId = table.Column<string>(type: "character varying", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationGuid = table.Column<string>(type: "character varying", nullable: false),
                    IsEnabled = table.Column<bool>(type: "boolean", nullable: false, defaultValueSql: "true"),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    ConcurrencyStamp = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()"),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "ID", "ConcurrencyStamp", "DeletedAt", "IsDeleted", "Name", "TenantId" },
                values: new object[] { new Guid("3246bc14-c348-4e4e-9b0d-5d1d51760d16"), new Guid("00000000-0000-0000-0000-000000000000"), null, false, "Unnamed", new Guid("00000000-0000-0000-0000-000000000000") });

            migrationBuilder.InsertData(
                schema: "Consultation",
                table: "ConsultationType",
                columns: new[] { "ID", "ConcurrencyStamp", "DeletedAt", "Description", "GroupId", "IsDeleted", "Name", "SortOrder", "TenantId" },
                values: new object[,]
                {
                    { new Guid("3259dc78-49d0-4359-8c8b-b3cfe7ccc421"), new Guid("00000000-0000-0000-0000-000000000000"), null, "Follow-up visit after a surgical procedure", new Guid("3246bc14-c348-4e4e-9b0d-5d1d51760d16"), false, "Post-surgical Follow-up", null, new Guid("00000000-0000-0000-0000-000000000000") },
                    { new Guid("5037e7ae-864c-4336-b0bd-32350cf334aa"), new Guid("00000000-0000-0000-0000-000000000000"), null, "Urgent consultation for acute illnesses or injuries", new Guid("3246bc14-c348-4e4e-9b0d-5d1d51760d16"), false, "Emergency Consultation", null, new Guid("00000000-0000-0000-0000-000000000000") },
                    { new Guid("73e5ed91-581e-47bf-8d7e-9c273847c483"), new Guid("00000000-0000-0000-0000-000000000000"), null, "Consultation for mental health issues (e.g., with a psychiatrist or psychologist)", new Guid("3246bc14-c348-4e4e-9b0d-5d1d51760d16"), false, "Mental Health Consultation", null, new Guid("00000000-0000-0000-0000-000000000000") },
                    { new Guid("ab3dc83a-0841-45ea-822d-19580b32cd91"), new Guid("00000000-0000-0000-0000-000000000000"), null, "Consultation with a medical specialist (e.g., cardiologist, neurologist)", new Guid("3246bc14-c348-4e4e-9b0d-5d1d51760d16"), false, "Specialist Consultation", null, new Guid("00000000-0000-0000-0000-000000000000") },
                    { new Guid("c3221472-9a87-4be9-982a-d442296b487a"), new Guid("00000000-0000-0000-0000-000000000000"), null, "Consultation before undergoing surgery", new Guid("3246bc14-c348-4e4e-9b0d-5d1d51760d16"), false, "Pre-surgical Consultation", null, new Guid("00000000-0000-0000-0000-000000000000") },
                    { new Guid("cda4df14-aa1c-4fc9-86a4-cb855b84b555"), new Guid("00000000-0000-0000-0000-000000000000"), null, "Routine health check-up with primary care physician", new Guid("3246bc14-c348-4e4e-9b0d-5d1d51760d16"), false, "General Check-up", null, new Guid("00000000-0000-0000-0000-000000000000") },
                    { new Guid("f9c35417-bc70-4035-b70a-ac2c71b8a051"), new Guid("00000000-0000-0000-0000-000000000000"), null, "Subsequent check-up following an initial consultation or treatment", new Guid("3246bc14-c348-4e4e-9b0d-5d1d51760d16"), false, "Follow-up Check-up", null, new Guid("00000000-0000-0000-0000-000000000000") }
                });

            migrationBuilder.InsertData(
                schema: "Consultation",
                table: "Consultation",
                columns: new[] { "ID", "ConcurrencyStamp", "DeletedAt", "Description", "IsDeleted", "Name", "ShortName", "TenantId", "TypeID" },
                values: new object[,]
                {
                    { new Guid("0297352d-4788-4ee4-9241-e2cea66e41cd"), new Guid("00000000-0000-0000-0000-000000000000"), null, "Consultation for disorders of the nervous system, brain, and spinal cord", false, "Neurologist", null, new Guid("00000000-0000-0000-0000-000000000000"), new Guid("ab3dc83a-0841-45ea-822d-19580b32cd91") },
                    { new Guid("17d8f674-e960-4b4b-ac54-4d1f9a42a8d7"), new Guid("00000000-0000-0000-0000-000000000000"), null, "Mental health consultations, including therapy and medication management", false, "Psychiatrist/Psychologist", null, new Guid("00000000-0000-0000-0000-000000000000"), new Guid("ab3dc83a-0841-45ea-822d-19580b32cd91") },
                    { new Guid("439c4908-63e2-4648-92b6-8ed10772e7ef"), new Guid("00000000-0000-0000-0000-000000000000"), null, "Routine health check-up with a primary care physician", false, "General Check-up", null, new Guid("00000000-0000-0000-0000-000000000000"), new Guid("ab3dc83a-0841-45ea-822d-19580b32cd91") },
                    { new Guid("46e7bbe6-7ffe-47f7-858b-0f521273eb0f"), new Guid("00000000-0000-0000-0000-000000000000"), null, "Eye examinations, vision care, and treatment of eye-related conditions", false, "Optometrist/Ophthalmologist", null, new Guid("00000000-0000-0000-0000-000000000000"), new Guid("ab3dc83a-0841-45ea-822d-19580b32cd91") },
                    { new Guid("66e64415-73ea-4797-bc0a-d13a2c095501"), new Guid("00000000-0000-0000-0000-000000000000"), null, "Routine health check-up with primary care physician", false, "General Check-up", null, new Guid("00000000-0000-0000-0000-000000000000"), new Guid("cda4df14-aa1c-4fc9-86a4-cb855b84b555") },
                    { new Guid("8c0d8be1-5241-40e9-bf2c-5a458ba58bac"), new Guid("00000000-0000-0000-0000-000000000000"), null, "Consultation for conditions affecting the ear, nose, and throat", false, "ENT (Ear, Nose, Throat)", null, new Guid("00000000-0000-0000-0000-000000000000"), new Guid("ab3dc83a-0841-45ea-822d-19580b32cd91") },
                    { new Guid("901e6429-b7a1-421e-a72c-f25f4963e81b"), new Guid("00000000-0000-0000-0000-000000000000"), null, "Healthcare for infants, children, and adolescents", false, "Pediatrician", null, new Guid("00000000-0000-0000-0000-000000000000"), new Guid("ab3dc83a-0841-45ea-822d-19580b32cd91") },
                    { new Guid("aa4e36c7-cde2-481b-9c6a-e7276ab8f55a"), new Guid("00000000-0000-0000-0000-000000000000"), null, "Consultation for issues related to bones, joints, muscles, and ligaments", false, "Orthopedist", null, new Guid("00000000-0000-0000-0000-000000000000"), new Guid("ab3dc83a-0841-45ea-822d-19580b32cd91") },
                    { new Guid("ac671073-c789-41c4-8c63-eb9c9084fde9"), new Guid("00000000-0000-0000-0000-000000000000"), null, "Heart and cardiovascular system related consultations", false, "Cardiologist", null, new Guid("00000000-0000-0000-0000-000000000000"), new Guid("ab3dc83a-0841-45ea-822d-19580b32cd91") },
                    { new Guid("c051027c-dd33-4b2b-ac59-0024e650b231"), new Guid("00000000-0000-0000-0000-000000000000"), null, "Skin related consultations, including skin diseases, allergies, and cosmetic concerns", false, "Dermatologist", null, new Guid("00000000-0000-0000-0000-000000000000"), new Guid("ab3dc83a-0841-45ea-822d-19580b32cd91") },
                    { new Guid("f354d822-c472-4677-8086-7d6ec89047bf"), new Guid("00000000-0000-0000-0000-000000000000"), null, "Consultation for digestive system and gastrointestinal tract issues", false, "Gastroenterologist", null, new Guid("00000000-0000-0000-0000-000000000000"), new Guid("ab3dc83a-0841-45ea-822d-19580b32cd91") }
                });
