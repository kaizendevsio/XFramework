...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https: //go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BillsPaymentTransaction>(entity =>
        {
            ...
            entity.HasOne(d => d.IdentityCredential).WithMany(p => p.BillsPaymentTransactions)
        ...
        modelBuilder.Entity<BusinessPackage>(entity =>
        {
            ...
            entity.HasOne(d => d.ConsumedByNavigation).WithMany(p => p.BusinessPackageConsumedByNavigations)
                .HasForeignKey(d => d.ConsumedBy)
                .HasConstraintName("tbl_userbusinesspackage_fk");

            entity.HasOne(d => d.IdentityCredential).WithMany(p => p.BusinessPackageIdentityCredentials)
                .HasForeignKey(d => d.IdentityCredentialId)
            ...
            entity.HasOne(d => d.RecipientIdentityCredential)
                ...
                .HasForeignKey(d => d.RecipientIdentityCredentialId)
        ...
        modelBuilder.Entity<BusinessPackageInclusion>(entity =>
        {
            ...
            entity.HasOne(d => d.InclusionType).WithMany(p => p.BusinessPackageInclusions)
                .HasForeignKey(d => d.InclusionTypeId)
                .HasConstraintName("BusinessPackageInclusionsTypeID");
        });
        ...
        modelBuilder.Entity<BusinessPackageUpgradeTransaction>(entity =>
        {
            ...
            entity.HasOne(d => d.IdentityCredential).WithMany(p => p.BusinessPackageUpgradeTransactions)
                .HasForeignKey(d => d.IdentityCredentialId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("ubput_tbl_identitycredentials_id_fk");

            entity.HasOne(d => d.PreviousBusinessPackage)
                .WithMany(p => p.BusinessPackageUpgradeTransactions)
                .HasForeignKey(d => d.PreviousBusinessPackageId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("ubput_tbl_businesspackage_id_fk_2");
        });
        ...
        modelBuilder.Entity<DepositRequest>(entity =>
        {
            ...
            entity.HasOne(d => d.TargetWalletType).WithMany(p => p.DepositRequests)
        ...
        modelBuilder.Entity<EloadTransaction>(entity =>
        {
            ...
            entity.HasOne(d => d.IdentityCredential).WithMany(p => p.EloadTransactions)
                .HasForeignKey(d => d.IdentityCredentialId)
                .HasConstraintName("IdentityCredentialId");
        ...
        modelBuilder.Entity<IdentityRole>(entity =>
        {
            ...
            entity.HasIndex(e => e.RoleTypeId, "IX_tbl_IdentityRoles_RoleTypeID");
            ...
            entity.HasOne(d => d.RoleType).WithMany(p => p.IdentityRoles)
        ...
        modelBuilder.Entity<IdentityRoleType>(entity =>
        {
            ...
            entity.HasOne(d => d.Application).WithMany(p => p.IdentityRoleTypes)
                .HasForeignKey(d => d.ApplicationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<IncomeTransaction>(entity =>
        {
            ...
            entity.HasOne(d => d.IdentityCredential).WithMany(p => p.IncomeTransactions)
                .HasForeignKey(d => d.IdentityCredentialId)
                .HasConstraintName("IdentityCredentialId");
        ...
        modelBuilder.Entity<Wallet>(entity =>
        {
            ...
            entity.HasOne(d => d.IdentityCredential).WithMany(p => p.Wallets)
                .HasForeignKey(d => d.IdentityCredentialId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<WalletType>(entity =>
        {
            ...
            entity.HasOne(d => d.Application).WithMany(p => p.WalletTypes)
                .HasForeignKey(d => d.ApplicationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<WalletTransaction>(entity =>
        {
            ...
            entity.HasOne(d => d.IdentityCredential).WithMany(p => p.WalletTransactions)
                .HasForeignKey(d => d.IdentityCredentialId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("UserAuthID");

            entity.HasOne(d => d.SourceUserWallet).WithMany(p => p.WalletTransactionSourceUserWallets)
                .HasForeignKey(d => d.SourceUserWalletId)
                .HasConstraintName("SourceUserWalletId");

            entity.HasOne(d => d.TargetUserWallet).WithMany(p => p.WalletTransactionTargetUserWallets)
        ...
        modelBuilder.Entity<WithdrawalRequest>(entity =>
        {
            ...
            entity.HasOne(d => d.IdentityCredential).WithMany(p => p.WithdrawalRequests)
                .HasForeignKey(d => d.IdentityCredentialId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("IdentityCredentialId");

            entity.HasOne(d => d.SourceWalletType).WithMany(p => p.WithdrawalRequestSourceWalletTypes)
                .HasForeignKey(d => d.SourceWalletTypeId)
                .HasConstraintName("SourceWalletTypeId");

            entity.HasOne(d => d.TargetCurrency).WithMany(p => p.WithdrawalRequestTargetCurrencies)
