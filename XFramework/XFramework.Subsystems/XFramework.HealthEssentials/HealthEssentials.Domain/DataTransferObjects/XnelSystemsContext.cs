...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DepositRequest>(entity =>
        {
            ...
            entity.HasIndex(e => e.Guid, "tbl_userdepositrequest_guid_uindex").IsUnique();
        ...
        modelBuilder.Entity<Wallet>(entity =>
        {
            ...
            entity.HasOne(d => d.WalletEntity).WithMany(p => p.Wallets)
        ...
        modelBuilder.Entity<WalletAddress>(entity =>
        {
            ...
            entity.HasIndex(e => e.Guid, "tbl_userwalletaddress_guid_uindex").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("tbl_WalletEntities_pkey");
            ...
            entity.HasOne(d => d.Application).WithMany(p => p.WalletEntities)
                .HasForeignKey(d => d.ApplicationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("tbl_walletentities_tbl_applications_id_fk");

            entity.HasOne(d => d.CurrencyEntity).WithMany(p => p.WalletEntities)
        ...
        modelBuilder.Entity<WalletTransaction>(entity =>
        {
            ...
            entity.HasIndex(e => e.Guid, "tbl_userwallettransaction_guid_uindex").IsUnique();
        ...
        modelBuilder.Entity<WithdrawalRequest>(entity =>
        {
            ...
            entity.HasIndex(e => e.Guid, "tbl_userwithdrawalrequest_guid_uindex").IsUnique();
