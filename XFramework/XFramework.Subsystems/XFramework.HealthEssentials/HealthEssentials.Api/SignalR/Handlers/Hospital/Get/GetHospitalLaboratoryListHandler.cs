...
public class GetHospitalLaboratoryListHandler : BaseSignalRHandler, ISignalREventHandler
{
    public void Handle(HubConnection connection, IMediator mediator)
    {
        HandleRequestQuery<GetHospitalLaboratoryListRequest, GetHospitalLaboratoryListQuery, List<HospitalLaboratoryResponse>>(connection, mediator);
    }
}