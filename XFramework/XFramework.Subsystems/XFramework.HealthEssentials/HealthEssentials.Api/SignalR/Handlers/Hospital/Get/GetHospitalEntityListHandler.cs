...
public class GetHospitalEntityListHandler : BaseSignalRHandler, ISignalREventHandler
{
    public void Handle(HubConnection connection, IMediator mediator)
    {
        HandleRequestQuery<GetHospitalEntityListRequest, GetHospitalEntityListQuery, List<HospitalEntityResponse>>(connection, mediator);
    }
}