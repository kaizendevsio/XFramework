...
public class GetHospitalServiceTagListHandler : BaseSignalRHandler, ISignalREventHandler
{
    public void Handle(HubConnection connection, IMediator mediator)
    {
        HandleRequestQuery<GetHospitalServiceTagListRequest, GetHospitalServiceTagListQuery, List<HospitalServiceTagResponse>>(connection, mediator);
    }
}