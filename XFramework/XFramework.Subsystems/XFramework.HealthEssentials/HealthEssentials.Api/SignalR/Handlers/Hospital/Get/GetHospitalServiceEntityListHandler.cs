...
public class GetHospitalServiceEntityListHandler : BaseSignalRHandler, ISignalREventHandler
{
    public void Handle(HubConnection connection, IMediator mediator)
    {
        HandleRequestQuery<GetHospitalServiceEntityListRequest, GetHospitalServiceEntityListQuery, List<HospitalServiceEntityResponse>>(connection, mediator);
    }
}