...
public class GetHospitalServiceListHandler : BaseSignalRHandler, ISignalREventHandler
{
    public void Handle(HubConnection connection, IMediator mediator)
    {
        HandleRequestQuery<GetHospitalServiceListRequest, GetHospitalServiceListQuery, List<HospitalServiceResponse>>(connection, mediator);
    }
}