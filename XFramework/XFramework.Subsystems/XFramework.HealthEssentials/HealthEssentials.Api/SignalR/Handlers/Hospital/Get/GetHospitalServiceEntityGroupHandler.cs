...
public class GetHospitalServiceEntityGroupHandler : BaseSignalRHandler, ISignalREventHandler
{
    public void Handle(HubConnection connection, IMediator mediator)
    {
        HandleRequestQuery<GetHospitalServiceEntityGroupRequest, GetHospitalServiceEntityGroupQuery, HospitalServiceEntityGroupResponse>(connection, mediator);
    }
}