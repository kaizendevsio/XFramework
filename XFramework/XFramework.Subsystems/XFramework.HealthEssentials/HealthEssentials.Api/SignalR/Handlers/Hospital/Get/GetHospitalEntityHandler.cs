...
public class GetHospitalEntityHandler : BaseSignalRHandler, ISignalREventHandler
{
    public void Handle(HubConnection connection, IMediator mediator)
    {
        HandleRequestQuery<GetHospitalEntityRequest, GetHospitalEntityQuery, HospitalEntityResponse>(connection, mediator);
    }
}