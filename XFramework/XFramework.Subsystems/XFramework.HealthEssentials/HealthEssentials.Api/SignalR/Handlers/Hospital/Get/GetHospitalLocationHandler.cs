...
public class GetHospitalLocationHandler : BaseSignalRHandler, ISignalREventHandler
{
    public void Handle(HubConnection connection, IMediator mediator)
    {
        HandleRequestQuery<GetHospitalLocationRequest, GetHospitalLocationQuery, HospitalLocationResponse>(connection, mediator);
    }
}