...
public class GetHospitalListHandler : BaseSignalRHandler, ISignalREventHandler
{
    public void Handle(HubConnection connection, IMediator mediator)
    {
        HandleRequestQuery<GetHospitalListRequest, GetHospitalListQuery, List<HospitalResponse>>(connection, mediator);
    }
}