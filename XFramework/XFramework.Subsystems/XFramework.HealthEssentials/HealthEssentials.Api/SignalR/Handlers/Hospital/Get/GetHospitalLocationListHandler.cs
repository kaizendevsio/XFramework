...
public class GetHospitalLocationListHandler : BaseSignalRHandler, ISignalREventHandler
{
    public void Handle(HubConnection connection, IMediator mediator)
    {
        HandleRequestQuery<GetHospitalLocationListRequest, GetHospitalLocationListQuery, List<HospitalLocationResponse>>(connection, mediator);
    }
}