...
public class CreateConsultationEntityHandler : BaseSignalRHandler, ISignalREventHandler
{
    public void Handle(HubConnection connection, IMediator mediator)
    {
        HandleRequestCmd<CreateConsultationEntityRequest, CreateConsultationEntityCmd>(connection, mediator);
    }
}