...
public class GetLogisticRiderTagHandler : BaseSignalRHandler, ISignalREventHandler
{
    public void Handle(HubConnection connection, IMediator mediator)
    {
        HandleRequestQuery<GetLogisticRiderTagRequest, GetLogisticRiderTagQuery, LogisticRiderTagResponse>(connection, mediator);
    }
}