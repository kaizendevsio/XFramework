...
public class GetLogisticEntityHandler : BaseSignalRHandler, ISignalREventHandler
{
    public void Handle(HubConnection connection, IMediator mediator)
    {
        HandleRequestQuery<GetLogisticEntityRequest, GetLogisticEntityQuery, LogisticEntityResponse>(connection, mediator);
    }
}