...
public class UpdateMedicineEntityGroupHandler : BaseSignalRHandler, ISignalREventHandler
{
    public void Handle(HubConnection connection, IMediator mediator)
    {
        HandleRequestCmd<UpdateMedicineEntityGroupRequest, UpdateMedicineEntityGroupCmd>(connection, mediator);
    }
}