...
public class DeleteMedicineIntakeHandler : BaseSignalRHandler, ISignalREventHandler
{
    public void Handle(HubConnection connection, IMediator mediator)
    {
        HandleRequestCmd<DeleteMedicineIntakeRequest, DeleteMedicineIntakeCmd>(connection, mediator);
    }
}