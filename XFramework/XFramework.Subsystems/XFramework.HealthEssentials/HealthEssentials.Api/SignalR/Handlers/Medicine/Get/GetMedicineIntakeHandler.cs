...
public class GetMedicineIntakeHandler : BaseSignalRHandler, ISignalREventHandler
{
    public void Handle(HubConnection connection, IMediator mediator)
    {
        HandleRequestQuery<GetMedicineIntakeRequest, GetMedicineIntakeQuery, MedicineIntakeResponse>(connection, mediator);
    }
}