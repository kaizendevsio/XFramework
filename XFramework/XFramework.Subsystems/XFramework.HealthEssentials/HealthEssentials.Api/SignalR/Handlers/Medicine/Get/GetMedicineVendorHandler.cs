...
public class GetMedicineVendorHandler : BaseSignalRHandler, ISignalREventHandler
{
    public void Handle(HubConnection connection, IMediator mediator)
    {
        HandleRequestQuery<GetMedicineVendorRequest, GetMedicineVendorQuery, MedicineVendorResponse>(connection, mediator);
    }
}