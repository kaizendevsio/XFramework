...
public class GetMedicineEntityGroupListHandler : BaseSignalRHandler, ISignalREventHandler
{
    public void Handle(HubConnection connection, IMediator mediator)
    {
        HandleRequestQuery<GetMedicineEntityGroupListRequest, GetMedicineEntityGroupListQuery, List<MedicineEntityGroupResponse>>(connection, mediator);
    }
}