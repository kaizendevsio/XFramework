...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BinaryList>(entity =>
        {
            ...
            entity.HasIndex(e => e.Guid, "tbl_userbinarylist_guid_uindex").IsUnique();
        ...
        modelBuilder.Entity<BinaryListMultiplex>(entity =>
        {
            ...
            entity.HasIndex(e => e.Guid, "tbl_userbinarylistmultiplex_guid_uindex").IsUnique();
        ...
        modelBuilder.Entity<BinaryMap>(entity =>
        {
            ...
            entity.HasIndex(e => e.Guid, "tbl_usermap_guid_uindex").IsUnique();
        ...
        modelBuilder.Entity<CommissionDeductionRequest>(entity =>
        {
            ...
            entity.HasIndex(e => e.Id, "tbl_usercommissiondeductionrequest_\"id\"_uindex").IsUnique();

            entity.HasIndex(e => e.Guid, "tbl_usercommissiondeductionrequest_guid_uindex").IsUnique();
        ...
        modelBuilder.Entity<Subscription>(entity =>
        {
            ...
            entity.HasIndex(e => e.Guid, "subscription_guid_uindex").IsUnique();
            ...
            entity.HasOne(d => d.Entity).WithMany(p => p.Subscriptions)
                .HasForeignKey(d => d.EntityId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<SubscriptionEntity>(entity =>
        {
            ...
            entity.HasIndex(e => e.Guid, "subscriptionentity_guid_uindex").IsUnique();
