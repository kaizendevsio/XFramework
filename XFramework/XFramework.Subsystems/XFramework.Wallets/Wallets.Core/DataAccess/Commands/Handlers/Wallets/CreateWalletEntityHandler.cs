...
public class CreateWalletEntityHandler : CommandBaseHandler, IRequestHandler<CreateWalletEntityCmd, CmdResponseBO<CreateWalletEntityCmd>>
{
    ...
    public async Task<CmdResponseBO<CreateWalletEntityCmd>> Handle(CreateWalletEntityCmd request, CancellationToken cancellationToken)
    {
