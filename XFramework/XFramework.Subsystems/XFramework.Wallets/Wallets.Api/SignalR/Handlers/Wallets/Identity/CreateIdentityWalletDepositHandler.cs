...
namespace Wallets.Api.SignalR.Handlers.Identity
{
    public class CreateIdentityWalletDepositHandler : BaseSignalRHandler, ISignalREventHandler
    {
                ...
                async (data, message, telemetryString) =>
                {
                    Task.Run(async () =>
                    {
                        ...
                        try
                        {
                            ...
                            var r = data.AsMediatorCmd<CreateIdentityWalletDepositRequest, CreateIdentityWalletDepositQuery>();
