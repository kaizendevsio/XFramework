...
{
    public class DecrementIdentityWalletHandler  : BaseSignalRHandler, ISignalREventHandler
    {
                ...
                async (data, message, telemetryString) =>
                {
                    Task.Run(async () =>
                    {
                        ...
                        try
                        {
                            ...
                            var r = data.AsMediatorCmd<DecrementIdentityWalletRequest, DecrementIdentityWalletCmd>();
