...
{
    public class IncrementIdentityWalletHandler  : BaseSignalRHandler, ISignalREventHandler
    {
            ...
            connection.On<string, string, string>(GetType().Name.Replace("Handler", string.Empty),
                async (data, message, telemetryString) =>
                {
                    ...
                    try
                    {
                        ...
                        var r = data.AsMediatorCmd<IncrementIdentityWalletRequest, IncrementIdentityWalletCmd>();
