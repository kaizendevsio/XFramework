...
namespace PaymentGateways.Domain.DataTransferObjects
{
    public partial class XFrameworkContext : DbContext
    {
        ...
        public virtual DbSet<TblGatewayCategory> TblGatewayCategories { get; set; }
        public virtual DbSet<TblGatewayEndpoint> TblGatewayEndpoints { get; set; }
        public virtual DbSet<TblGatewayEntity> TblGatewayEntities { get; set; }
        ...
        public virtual DbSet<TblIncomeDistribution> TblIncomeDistributions { get; set; }
        public virtual DbSet<TblIncomeEntity> TblIncomeEntities { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.ToTable("tbl_Gateways", "Integration.PaymentGateway");
                ...
                entity.HasOne(d => d.GatewayCategory)
                    .WithMany(p => p.TblGateways)
                    .HasForeignKey(d => d.GatewayCategoryId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("tbl_gateways_tbl_gatewaycategories_id_fk");

                entity.HasOne(d => d.GatewayEndpoint)
                    .WithMany(p => p.TblGateways)
                    .HasForeignKey(d => d.GatewayEndpointId)
                    .HasConstraintName("tbl_gateways_tbl_providerendpoints_id_fk");
            });

            modelBuilder.Entity<TblGatewayCategory>(entity =>
            {
                entity.ToTable("tbl_GatewayCategories", "Integration.PaymentGateway");
                ...
                entity.Property(e => e.GatewayEntityId).HasColumnName("GatewayEntityID");
                ...
                entity.HasOne(d => d.GatewayEntity)
                    .WithMany(p => p.TblGatewayCategories)
                    .HasForeignKey(d => d.GatewayEntityId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("tbl_gatewaycategories___fk");
            });

            modelBuilder.Entity<TblGatewayEndpoint>(entity =>
            {
                entity.ToTable("tbl_GatewayEndpoints", "Integration.PaymentGateway");
                ...
                entity.HasOne(d => d.GatewayEntity)
                    .WithMany(p => p.TblGatewayEndpoints)
                    .HasForeignKey(d => d.GatewayEntityId)
                    .HasConstraintName("tbl_gatewayendpoints___fk");
            });

            modelBuilder.Entity<TblGatewayEntity>(entity =>
            {
                entity.ToTable("tbl_GatewayEntities", "Integration.PaymentGateway");

                entity.HasIndex(e => e.Id, "tbl_gatewayentities_id_uindex")
                    .IsUnique();

                entity.HasIndex(e => e.Uuid, "tbl_gatewayentities_uuid_uindex")
                    .IsUnique();
            ...
            modelBuilder.Entity<TblIdentityCredential>(entity =>
            {
                ...
                entity.HasIndex(e => e.Cuid, "tbl_identitycredentials_cuid_uindex")
                    .IsUnique();
            ...
            {
                entity.ToTable("tbl_IncomeDistribution", "BusinessIncome");
                ...
                entity.Property(e => e.IncomeEntityId).HasColumnName("IncomeEntityID");
                ...
                entity.HasOne(d => d.IncomeEntity)
                    .WithMany(p => p.TblIncomeDistributions)
                    .HasForeignKey(d => d.IncomeEntityId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("IncomeTypeID");
            });

            modelBuilder.Entity<TblIncomeEntity>(entity =>
            {
                entity.ToTable("tbl_IncomeEntities", "BusinessIncome");
            ...
            modelBuilder.Entity<TblUserBillsPaymentTransaction>(entity =>
            {
                ...
                entity.Property(e => e.RawRequest).HasMaxLength(1000);

                entity.Property(e => e.RawResponse).HasMaxLength(1000);

                entity.Property(e => e.ReferenceNo).HasMaxLength(20);

                entity.Property(e => e.ResponseReasonPhrase).HasMaxLength(1000);
            ...
            modelBuilder.Entity<TblUserDepositRequest>(entity =>
            {
                ...
                entity.HasOne(d => d.Gateway)
                    ...
                    .HasConstraintName("tbl_userdepositrequest_tbl_gateways_id_fk");
