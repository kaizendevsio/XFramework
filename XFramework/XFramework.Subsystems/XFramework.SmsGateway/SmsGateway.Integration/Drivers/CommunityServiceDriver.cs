...
using SmsGateway.Domain.Generic.Contracts.Responses.Connection;
using SmsGateway.Domain.Generic.Contracts.Responses.Content;
using SmsGateway.Domain.Generic.Contracts.Responses.Identity;
