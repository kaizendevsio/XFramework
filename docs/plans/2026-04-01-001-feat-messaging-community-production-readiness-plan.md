# Messaging & Community Production Readiness Implementation Plan
...
**Goal:** Fix critical bugs and add missing endpoints across Messaging and Community services to reach production readiness (Groups A & B from the spec).
...
| Modify | `src/Modules/XFramework.Messaging/Messaging.Domain.Shared/Contracts/MessageDirect.cs` |
| Modify | `src/Modules/XFramework.Messaging/Messaging.Domain.Shared/Contracts/Requests/Update/UpdateMessageDirectRequest.cs` |
| Modify | `src/Modules/XFramework.Messaging/Messaging.Api/Services/MessagingService.cs` |
| Modify | `src/Modules/XFramework.Messaging/Messaging.Api/Features/Messages/UpdateDirect/UpdateDirectMessageValidator.cs` |
| Modify | `src/Modules/XFramework.Messaging/Messaging.Api/Features/Messages/GetMessages/GetThreadMessagesValidator.cs` |
| Create | `src/Modules/XFramework.Messaging/Messaging.Api/Features/Threads/GetList/GetThreadListValidator.cs` |
...
| Action | File |
|--------|------|
| Create | `src/Modules/XFramework.Messaging/Messaging.Domain.Shared/Contracts/Requests/Threads/UpdateThreadRequest.cs` |
| Create | `src/Modules/XFramework.Messaging/Messaging.Api/Features/Threads/Update/Endpoint.cs` |
| Create | `src/Modules/XFramework.Messaging/Messaging.Api/Features/Threads/Update/UpdateThreadValidator.cs` |
| Modify | `src/Modules/XFramework.Messaging/Messaging.Api/Services/IThreadService.cs` |
| Modify | `src/Modules/XFramework.Messaging/Messaging.Api/Services/ThreadService.cs` |
| Modify | `src/Modules/XFramework.Messaging/Messaging.Domain.Shared/Constants.cs` |
| Modify | `src/Modules/XFramework.Messaging/Messaging.Domain.Shared/Contracts/MessageReaction.cs` |
| Modify | `src/Modules/XFramework.Messaging/Messaging.Domain.Shared/Configurations/MessageReactionConfiguration.cs` |
| Create | `src/Modules/XFramework.Messaging/Messaging.Domain.Shared/Contracts/Requests/Threads/MarkMessagesReadRequest.cs` |
| Create | `src/Modules/XFramework.Messaging/Messaging.Api/Features/Messages/MarkRead/Endpoint.cs` |
| Create | `src/Modules/XFramework.Messaging/Messaging.Api/Features/Messages/MarkRead/MarkMessagesReadValidator.cs` |
...
In `Messaging.Domain.Shared/Contracts/MessageDirect.cs`, rename property at line 52:
...
In `Messaging.Domain.Shared/Contracts/Requests/Update/UpdateMessageDirectRequest.cs`, rename property at line 13:

Old: `public DateTime? RecievedAt { get; set; }`
New: `public DateTime? ReceivedAt { get; set; }`

- [ ] **Step 3: Fix MessagingService**

In `Messaging.Api/Services/MessagingService.cs`, at line 125:
...
In `Messaging.Api/Features/Messages/UpdateDirect/UpdateDirectMessageValidator.cs`, replace all `RecievedAt` references:
...
Run: `dotnet build src/Modules/XFramework.Messaging/Messaging.Api/Messaging.Api.csproj --no-restore`
Expected: Build succeeded

- [ ] **Step 6: Commit**

```bash
git add src/Modules/XFramework.Messaging/
...
In `Messaging.Api/Features/Messages/GetMessages/GetThreadMessagesValidator.cs`, replace the existing PageSize rule (lines 16-18) and add PageIndex:
...
Create file `Messaging.Api/Features/Threads/GetList/GetThreadListValidator.cs`:
...
```bash
git add src/Modules/XFramework.Messaging/Messaging.Api/Features/
git commit -m "fix: Add pagination bounds validation to Messaging list endpoints"
```
...
### Task 5: Messaging — Update Thread Endpoint (B5)
...
Create file `Messaging.Domain.Shared/Contracts/Requests/Threads/UpdateThreadRequest.cs`:
...
In `Messaging.Api/Services/IThreadService.cs`, add after the `GetThreadAsync` method (after line 17):
...
In `Messaging.Api/Services/ThreadService.cs`, add the method (before the `AddThreadMemberAsync` method):
...
Create file `Messaging.Api/Features/Threads/Update/Endpoint.cs`:
...
Create file `Messaging.Api/Features/Threads/Update/UpdateThreadValidator.cs`:
...
### Task 6: Messaging — Read Receipts (B6)
...
In `Messaging.Domain.Shared/Constants.cs`, add after the `GenericSender` class:
...
Create file `Messaging.Domain.Shared/Contracts/Requests/Threads/MarkMessagesReadRequest.cs`:
...
In `Messaging.Api/Services/IThreadService.cs`, add after the `DeleteMessageReactionAsync` method:
...
Create file `Messaging.Api/Features/Messages/MarkRead/Endpoint.cs`:
...
Create file `Messaging.Api/Features/Messages/MarkRead/MarkMessagesReadValidator.cs`:
...
### Task 7: Messaging — Fix Reactions Schema (B7)
...
In `Messaging.Domain.Shared/Contracts/MessageReaction.cs`, add after line 12 (after `TypeId`):
...
In `Messaging.Domain.Shared/Configurations/MessageReactionConfiguration.cs`, add after line 32 (after the message FK):
...
Run: `dotnet build src/Modules/XFramework.Messaging/Messaging.Api/Messaging.Api.csproj`
Expected: Build succeeded
