...
> Historical backlog migrated from `docs/superpowers/`. For new implementation planning, use `/ce-plan`; this note is retained as context for the unified ZLogger work.
