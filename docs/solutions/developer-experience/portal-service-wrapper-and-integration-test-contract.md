---
title: "Portal Service Wrapper And Integration Test Contract"
date: 2026-06-20
category: developer-experience
module: XFramework
problem_type: convention
component: portal_testing
severity: high
applies_when:
  - "Building Portal pages that call module APIs or mutate module data"
  - "Adding module integration tests for wrappers, remote IDataContext, or Portal smoke flows"
  - "Deciding whether a Blazor page should use a service wrapper or IDataContext"
tags: [portal, service-wrapper, datacontext, integration-tests, nunit, wrappers]
status: current
---

# Portal Service Wrapper And Integration Test Contract

## Decision Rule

Portal pages must use the most business-aware API available.
...
`IDataContext` remains the preferred Portal API for:
...
- Every Portal write path, including whether it uses the wrapper or remote `IDataContext`.
...
## Required Agent Audit Before Portal Changes

When touching a Portal module page:
