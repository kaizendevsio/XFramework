...
| Tests | `src/Modules/XFramework.Communications/Communications.Tests/Communications.Tests.csproj`, `src/Modules/XFramework.Coins/Server/Coins.Tests/Coins.Tests.csproj` |
...
| Presentation | Portal, gateway, Fluid app, generated/wrapper gateway endpoints, admin and finance/identity UI pages | `src/Presentation/XFramework.Portal/XFramework.Portal.csproj`, `src/Presentation/XFramework.Portal/Components/Pages/Finance/Wallets.razor`, `src/Presentation/XFramework.Portal/Components/Pages/Identity/Users.razor`, `src/Presentation/Gateway/Gateway.csproj`, `src/Presentation/Gateway/Endpoints/Endpoints.cs`, `src/Presentation/Fluid/Fluid.csproj` | `src/Presentation/BlueprintPoc/BlueprintPoc.csproj` exists but is not listed in `XFramework.slnx`; treat it as a local/poc surface unless separately brought into solution scope. |
