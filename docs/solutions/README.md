...
- [Communications backend post-IdentityServer revalidation](workflow-issues/communications-backend-audit-2026-08-04.md) - records current Communications findings, resolved trust concerns, token-cache verification, and production-readiness gaps after centralized invocation security.
