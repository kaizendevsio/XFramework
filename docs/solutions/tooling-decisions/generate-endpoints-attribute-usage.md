...
severity: medium
applies_when:
  - "Using GenerateEndpointsAttribute to generate service and REST CRUD patterns from entity classes"
tags: [source-generators, generate-endpoints, crud, vsa, endpoints]
---
...
- [Auto-Discovery Guide](./generated-endpoint-auto-discovery.md) - Complete usage documentation
- [Migration Guide](../developer-experience/migration-to-auto-discovery.md) - Migrate existing projects

## Related Documentation

- [Auto-Discovery Guide](./generated-endpoint-auto-discovery.md) - Automatic registration system
- [Migration Guide](../developer-experience/migration-to-auto-discovery.md) - Migrating to auto-discovery
- [XFramework Best Practices](../conventions/xframework-best-practices.md) - VSA architecture conventions
- [Caching Strategy](../best-practices/xframework-caching-strategy.md)
