...
- [Attribute Usage Guide](../source-generators/attribute-usage-guide.md)
- [Auto-Discovery Guide](../source-generators/auto-discovery-guide.md)
...
1. Review [ADR-003](.ruru/adrs/ADR-003-vsa-entity-placement-strategy.md) for architectural decisions
2. Check [Auto-Discovery Guide](../source-generators/auto-discovery-guide.md) for discovery issues
